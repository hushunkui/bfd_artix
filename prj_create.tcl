...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {aurora_gt_rst} \
   CONFIG.FREQ_HZ {125000000} \
 ] $aurora_init_clk
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_RESET {aurora_rst} \
 ] $aurora_usr_clk
  ...
  # Create instance: aurora_sys_reset, and set properties
  set aurora_sys_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset aurora_sys_reset ]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins aurora_8b10b_0/USER_DATA_S_AXI_TX] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_net -net aurora_8b10b_0_user_clk_out [get_bd_ports aurora_usr_clk] [get_bd_pins aurora_8b10b_0/user_clk_out] [get_bd_pins aurora_sys_reset/slowest_sync_clk] [get_bd_pins axis_data_fifo_0/s_axis_aclk]
  connect_bd_net -net aurora_rst_1 [get_bd_ports aurora_rst] [get_bd_pins aurora_8b10b_0/reset] [get_bd_pins aurora_sys_reset/ext_reset_in]
  connect_bd_net -net aurora_sys_reset_peripheral_aresetn [get_bd_pins aurora_sys_reset/peripheral_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn]
