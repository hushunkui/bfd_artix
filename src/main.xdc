...
set_property PACKAGE_PIN L5 [get_ports {usr_lvds_p[6]}]
set_property PACKAGE_PIN M5 [get_ports {usr_lvds_p[7]}]
set_property PACKAGE_PIN M2 [get_ports {usr_lvds_p[8]}]
set_property PACKAGE_PIN M1 [get_ports {usr_lvds_p[9]}]
...
set_property IOSTANDARD LVCMOS25 [get_ports {usr_lvds_p[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {usr_lvds_p[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {usr_lvds_p[8]}]
set_property IOSTANDARD LVCMOS25 [get_ports {usr_lvds_p[9]}]
