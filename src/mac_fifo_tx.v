...
mac_fifo_sync_block resync_rd_tran_frame_tog (
    .clk       (tx_fifo_aclk),
...
mac_fifo_sync_block resync_wr_frame_in_fifo (
    .clk       (tx_mac_aclk),
...
// Synchronize it back onto read domain for use in the read logic.
mac_fifo_sync_block resync_wr_frames_in_fifo (
    .clk       (tx_mac_aclk),
...
mac_fifo_sync_block resync_fif_valid_tog (
    .clk       (tx_mac_aclk),
...
mac_fifo_sync_block resync_rd_txfer_tog (
    .clk       (tx_fifo_aclk),
