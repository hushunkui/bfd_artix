...
#ETH1 (POARTB)
set_property PACKAGE_PIN         [get_ports {rgmii_txd[4]}]
set_property PACKAGE_PIN         [get_ports {rgmii_txd[5]}]
set_property PACKAGE_PIN         [get_ports {rgmii_txd[6]}]
set_property PACKAGE_PIN         [get_ports {rgmii_txd[7]}]
set_property PACKAGE_PIN         [get_ports {rgmii_tx_ctl[1]}]
set_property PACKAGE_PIN         [get_ports {rgmii_tx_c[1]}]

set_property PACKAGE_PIN         [get_ports {rgmii_rxd[4]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rxd[5]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rxd[6]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rxd[7]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rx_ctl[1]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rx_c[1]}]

set_property PACKAGE_PIN         [get_ports {eth_phy_rst[1]}]
...
#ETH2 (POARTC)
set_property PACKAGE_PIN         [get_ports {rgmii_txd[8]}]
set_property PACKAGE_PIN         [get_ports {rgmii_txd[9]}]
set_property PACKAGE_PIN         [get_ports {rgmii_txd[10]}]
set_property PACKAGE_PIN         [get_ports {rgmii_txd[11]}]
set_property PACKAGE_PIN         [get_ports {rgmii_tx_ctl[2]}]
set_property PACKAGE_PIN         [get_ports {rgmii_tx_c[2]}]

set_property PACKAGE_PIN         [get_ports {rgmii_rxd[8]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rxd[9]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rxd[10]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rxd[11]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rx_ctl[2]}]
set_property PACKAGE_PIN         [get_ports {rgmii_rx_c[2]}]

set_property PACKAGE_PIN         [get_ports {eth_phy_rst[2]}]
