...
add wave -noupdate -color {Slate Blue} -itemcolor Gold /test_phy_tb/test_phy/test_tx/fsm_cs
...
add wave -noupdate -color {Slate Blue} -itemcolor Gold /test_phy_tb/test_phy/test_rx/fsm_cs
add wave -noupdate /test_phy_tb/test_phy/test_rx/srcambler_sof
add wave -noupdate /test_phy_tb/test_phy/test_rx/test_data
...
update
WaveRestoreZoom {0 ps} {369544 ps}
