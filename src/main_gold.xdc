...
#
#set_property PACKAGE_PIN L4 [get_ports usr_spi_clk ]
#set_property PACKAGE_PIN L3 [get_ports usr_spi_cs  ]
#set_property PACKAGE_PIN M4 [get_ports usr_spi_mosi]
#set_property PACKAGE_PIN N4 [get_ports usr_spi_miso]
